...
private:
    ...
    static stLoginRegiterRecord _ConvertLinetoLoginRecord(string Line, string Seperator = "#//#")
    {
        stLoginRegiterRecord LoginRegisterRecord;

        vector <string> vLoginRegister = clsString::Split(Line , Seperator);

        LoginRegisterRecord.DataTime = vLoginRegister[0];
        LoginRegisterRecord.UserName = vLoginRegister[1];
        LoginRegisterRecord.Password = clsUtil::Decrypt(vLoginRegister[2] , 2);
...
public:
    ...
    {
        _EncryptPassword = clsUtil::Encrypt(Password, 2);
    }
    ...
    static vector <stLoginRegiterRecord> GetLoginRegisterList() {
        ...
        if (MyFile.is_open()) {
            ...
            while (getline(MyFile, Line)) {
                ...
                LoginRegisterRecord = _ConvertLinetoLoginRecord(Line);
